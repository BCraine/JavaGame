...
public class Wolf extends Animal{
	...
	public Wolf(String name, int age, char gender, float weight, boolean fur) {
	...
	public void damageGrenade(){
		System.out.println("The wolfs Health is " + wolfHealth);
		System.out.println("The grenade hurts the wolf");
		wolfHealth = wolfHealth - 100;
		System.out.println("The wolfs health is now " + wolfHealth);
		System.out.println();
	}
	public void damageFireball(){
		System.out.println("The wolfs Health is " + wolfHealth);
		System.out.println("The fireball hurts the wolf");
		wolfHealth = wolfHealth - 75;
		System.out.println("The wolfs health is now " + wolfHealth);
		System.out.println();
	}
	public void damageScratch(){
		System.out.println("The wolfs Health is " + wolfHealth);
		System.out.println("The scratch hurts the wolf");
		wolfHealth = wolfHealth - 30;
		System.out.println("The wolfs health is now " + wolfHealth);
		System.out.println();
	}
	public void damageStrike(){
		System.out.println("The wolfs Health is " + wolfHealth);
		System.out.println("The Strike hurts the wolf");
		wolfHealth = wolfHealth - 130;
		System.out.println("The wolfs health is now " + wolfHealth);
		System.out.println();
	}
	public void healPotion(){
		System.out.println("The wolfs Health is " + wolfHealth);
		System.out.println("The potion heals the wolf");
		wolfHealth = wolfHealth + 100;
		System.out.println("The wolfs health is now " + wolfHealth);
		System.out.println();
	}
	public void healCure(){
		System.out.println("The wolfs Health is " + wolfHealth);
		System.out.println("The cure heals the wolf");
		wolfHealth = wolfHealth + 250;
		System.out.println("The wolfs health is now " + wolfHealth);
		System.out.println();
	}
	...
	@Override
	public void speak() {
		System.out.println("the wolfs health reduces");
