...
protected boolean notFake;
	...
	public Cure(String name, boolean notFake) {
		super(name);
	...
	public void takeDamageTrooper(){
		...
		trooperHealth = trooperHealth - 40;
	...
	@Override
	public void speak() {
		System.out.println("The cure gives health");
