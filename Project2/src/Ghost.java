...
public class Ghost extends Undead{
	...
	public Ghost(String name, int age, char gender, float weight, boolean fur) {
	...
	public void damageGrenade(){
		System.out.println("The ghost's Health is " + ghostHealth);
		System.out.println("The grenade hurts the ghost");
		ghostHealth = ghostHealth - 100;
		System.out.println("The ghosts health is now " + ghostHealth);
		System.out.println();
	}
	public void damageFireball(){
		System.out.println("The ghosts Health is " + ghostHealth);
		System.out.println("The fireball hurts the ghost");
		ghostHealth = ghostHealth - 75;
		System.out.println("The ghosts health is now " + ghostHealth);
		System.out.println();
	}
	public void damageScratch(){
		System.out.println("The ghosts Health is " + ghostHealth);
		System.out.println("The scratch hurts the ghost");
		ghostHealth = ghostHealth - 30;
		System.out.println("The ghosts health is now " + ghostHealth);
		System.out.println();
	}
	public void damageStrike(){
		System.out.println("The ghosts Health is " + ghostHealth);
		System.out.println("The Strike hurts the ghost");
		ghostHealth = ghostHealth - 130;
		System.out.println("The ghosts health is now " + ghostHealth);
		System.out.println();
	}
	public void healPotion(){
		System.out.println("The ghosts Health is " + ghostHealth);
		System.out.println("The potion heals the ghost");
		ghostHealth = ghostHealth + 100;
		System.out.println("The ghosts health is now " + ghostHealth);
		System.out.println();
	}
	public void healCure(){
		System.out.println("The ghosts Health is " + ghostHealth);
		System.out.println("The cure heals the ghost");
		ghostHealth = ghostHealth + 250;
		System.out.println("The ghosts health is now " + ghostHealth);
		System.out.println();
	}
	...
	@Override
	public void speak() {
		System.out.println("the ghost's health reduces");
