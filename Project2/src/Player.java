...
public class Player extends Human{
	...
	public Player(String name, int age, char gender, float weight, boolean fur) {
	...
	public void damageGrenade(){
		System.out.println("Your Health is " + playerHealth);
		System.out.println("The grenade hurts you");
	...
	public void damageFireball(){
		System.out.println("Your Health is " + playerHealth);
		System.out.println("The fireball hurts you");
	...
	public void damageScratch(){
		System.out.println("Your Health is " + playerHealth);
		System.out.println("The scratch hurts your");
	...
	public void damageStrike(){
		System.out.println("Your Health is " + playerHealth);
		System.out.println("The Strike hurts you");
		playerHealth = playerHealth - 130;
		System.out.println("Your health is now " + playerHealth);
		System.out.println();
	}
	public void healPotion(){
		System.out.println("Your Health is " + playerHealth);
		System.out.println("The potion heals you");
		playerHealth = playerHealth + 100;
		System.out.println("Your health is now " + playerHealth);
		System.out.println();
	}
	public void healCure(){
		System.out.println("Your Health is " + playerHealth);
		System.out.println("The cure heals you");
		playerHealth = playerHealth + 250;
		System.out.println("Your health is now " + playerHealth);
		System.out.println();
	}
	...
	@Override
	public void speak() {
		System.out.println("The players health reduces");
