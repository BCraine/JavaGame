public class Potion extends Item{
	...
	public Potion(String name, float weight, boolean notFake) {
		super(name, weight);
	...
	public void setnotFake(boolean armor) {
		this.notFake = notFake;
	}
	...
	@Override
	public void speak() {
		System.out.println("The potion gives health");
