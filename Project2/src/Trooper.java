...
public class Trooper extends Human{
	...
	public Trooper(String name, int age, char gender, float weight, boolean fur) {
	...
	public void damageGrenade(){
		System.out.println("The troopers Health is " + trooperHealth);
		System.out.println("The grenade hurts the trooper");
		trooperHealth = trooperHealth - 100;
		System.out.println("The troopers health is now " + trooperHealth);
		System.out.println();
	}
	public void damageFireball(){
		System.out.println("The troopers Health is " + trooperHealth);
		System.out.println("The fireball hurts the trooper");
		trooperHealth = trooperHealth - 75;
		System.out.println("The troopers health is now " + trooperHealth);
		System.out.println();
	}
	public void damageScratch(){
		System.out.println("The troopers Health is " + trooperHealth);
		System.out.println("The scratch hurts the trooper");
		trooperHealth = trooperHealth - 30;
		System.out.println("The troopers health is now " + trooperHealth);
		System.out.println();
	}
	public void damageStrike(){
		System.out.println("The troopers Health is " + trooperHealth);
		System.out.println("The Strike hurts the trooper");
		trooperHealth = trooperHealth - 130;
		System.out.println("The troopers health is now " + trooperHealth);
		System.out.println();
	}
	public void healPotion(){
		System.out.println("The troopers Health is " + trooperHealth);
		System.out.println("The potion heals the trooper");
		trooperHealth = trooperHealth + 100;
		System.out.println("The troopers health is now " + trooperHealth);
		System.out.println();
	}
	public void healCure(){
		System.out.println("The troopers Health is " + trooperHealth);
		System.out.println("The cure heals the trooper");
		trooperHealth = trooperHealth + 250;
		System.out.println("The troopers health is now " + trooperHealth);
		System.out.println();
	}
	...
	@Override
	public void speak() {
		System.out.println("the troopers health reduces");
