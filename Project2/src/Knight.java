...
public class Knight extends Human {
	...
	public Knight(String name, int age, char gender, float weight, boolean fur) {
	...
	public void damageGrenade(){
		System.out.println("The knights Health is " + knightHealth);
		System.out.println("The grenade hurts the knight");
		knightHealth = knightHealth - 100;
		System.out.println("The knights health is now " + knightHealth);
		System.out.println();
	}
	public void damageFireball(){
		System.out.println("The knights health is " + knightHealth);
		System.out.println("The fireball hurts the knight");
		knightHealth = knightHealth - 75;
		System.out.println("The knights health is now " + knightHealth);
		System.out.println();
	}
	public void damageScratch(){
		System.out.println("The knights Health is " + knightHealth);
		System.out.println("The scratch hurts the knight");
		knightHealth = knightHealth - 30;
		System.out.println("The knights health is now " + knightHealth);
		System.out.println();
	}
	public void damageStrike(){
		System.out.println("The knights Health is " + knightHealth);
		System.out.println("The Strike hurts the knight");
		knightHealth = knightHealth - 130;
		System.out.println("The knights health is now " + knightHealth);
		System.out.println();
	}
	public void healPotion(){
		System.out.println("The knights Health is " + knightHealth);
		System.out.println("The potion heals the knight");
		knightHealth = knightHealth + 100;
		System.out.println("The knights health is now " + knightHealth);
		System.out.println();
	}
	public void healCure(){
		System.out.println("The knights Health is " + knightHealth);
		System.out.println("The cure heals the knight");
		knightHealth = knightHealth + 250;
		System.out.println("The knights health is now " + knightHealth);
		System.out.println();
	}
	...
	@Override
	public void speak() {
		System.out.println("the knights health reduces");
