...
public class Grenade extends Item{
	...
	public Grenade(String name, float weight, boolean notDecoy) {
		super(name, weight);
		this.notDecoy = notDecoy;
	}
	...
	public void setDecoy(boolean armor) {
		this.notDecoy = notDecoy;
	}
	...
	public void takeDamageTrooper(){
		...
		trooperHealth = trooperHealth - 25;
	...
	@Override
	public void speak() {
		System.out.println("The grenade deals damage");
